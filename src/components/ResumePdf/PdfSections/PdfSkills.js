  ...
  return (
    <View style={styles.skillBlock}>
      <View style={styles.skillLine}>
        ...
        <View style={{...styles.skills, color: 'black'}}>{ langs }</View>
      </View>
      <View style={styles.skillLine}>
        <Text style={styles.subheading}>Frameworks & Libraries:</Text>
        <View style={styles.skills}>{ frames }</View>
      </View>
      <View style={styles.skillLine}>
        <Text style={styles.subheading}>Tools & Databases:</Text>
        <View style={styles.skills}>{ toolss }</View>
      </View>
      {/* <View style={styles.skillLine}>
        <Text style={styles.subheading}>Additional Skills:</Text>
        <Text style={styles.skills}> Scikit-Learn, NLTK, Pandas, NumPy, Matplotlib, TensorFlow & Keras, YOLO, OpenCV </Text>
      </View> */}
    </View>
  );
}
